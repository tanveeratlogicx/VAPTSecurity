...
class VAPT_Input_Validator
{
     ...
     * @param string|null $level_override Optional sanitization level to force (e.g. for testing).
     *
     * @return array|WP_Error Sanitized data or a WP_Error.
     */
    public function validate(array $data, array $schema, $level_override = null)
    {
        $sanitized = [];
        ...
        foreach ($schema as $field => $rules) {
            ...
            // Get sanitization level from options or override
            if ($level_override) {
